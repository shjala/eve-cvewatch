...
# usage: ./compare.sh <master_scan.json> <pr_scan.json> [report_file] [ignore_file]
...
if [ $# -lt 2 ]; then
    echo "Usage: $0 <master_scan.json> <pr_scan.json> [report_file] [ignore_file]" >&2
    exit 1
fi
